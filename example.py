...
from xrlib.generate import RhythmGenerator
...
fjb_bar_pitch_list = [[e, g, e, d, g, g, a], [e, e, g, d, e, g],
                      [g, g, g, g, g, a], [d, e, d, g],
                      [d2, d2, e2, d2, e2, d2], [b, a, d2, g2],
                      [e2, d2, a, d2, e2], [b, b, d2, a, b, a, g]]

# Create a RhythmGenerator object
rg = RhythmGenerator(model)

# Generate melody using the list above
rg.generate_midi_from_pitch_list(fjb_pitch_list, output_path, n_outputs=10)

# Generate melody using the list above (experimental!)
rg.generate_midi_from_bar_pitch_list(
    fjb_bar_pitch_list, output_path, n_outputs=5)
